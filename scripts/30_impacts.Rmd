...
Filtrage des taxons que l'on veut garder
On renomme les espèces que l'on veut rassembrer.
```{r}
df_propre <- data %>%
...
mode_data <- mode_data[!is.infinite(mode_data$simpson),]
```
...
Affichage. Le tableau est mis en forme avec les fonctions du package `flextable`. La richesse est distingué par l'arrière-plan de couleur.
